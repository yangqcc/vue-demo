  ...
  },
  {
    ...
    subMenu: [
      { id: 31, level: 2, name: '架构', type: "link", url: "/detail/architecture" },
      {
        ...
        isSelected: false,
        subMenu: [
          { id: 321, level: 3, name: '显示数据', type: "button", url: "/detail/displaying-data" ,
            isExpanded: false,
            isSelected: false,
            subMenu: [
              { id: 32100, level: 4, name: '显示数据', type: "link", url: "/detail/displaying-data" },
              { id: 32200, level: 4, name: '模板语法', type: "link", url: "/detail/template-syntax" },
              { id: 32300, level: 4, name: '生命周期钩子', type: "link", url: "/detail/lifecycle-hooks" },
              { id: 32400, level: 4, name: '组件交互', type: "link", url: "/detail/component-interaction" },
              { id: 32500, level: 4, name: '组件样式', type: "link", url: "/detail/component-styles" },
              { id: 32600, level: 4, name: '动态组件', type: "link", url: "/detail/dynamic-component-loader" },
              { id: 32700, level: 4, name: '属性型指令', type: "link", url: "/detail/attribute-directives" },
              { id: 32800, level: 4, name: '结构型指令', type: "link", url: "/detail/structural-directives" },
              { id: 32900, level: 4, name: '管道', type: "link", url: "/detail/pipes" },
              { id: 3210, level: 4, name: '动画', type: "link", url: "/detail/animations" },
            ]
          },
